...
export default function About() {
  ...
  return (
    <section id="about" className="relative min-h-[100svh] bg-black overflow-hidden flex items-center py-12 sm:py-0">
      ...
      {/* Background effects */}
      <div className="absolute top-1/2 left-1/4 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] rounded-full bg-[#2d1654] blur-[100px] sm:blur-[150px] opacity-20"></div>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            <div className="relative w-48 h-48 sm:w-64 sm:h-64 md:w-72 md:h-72 mx-auto">
              ...
              ></div>
              <div 
                className="absolute top-0 right-0 w-10 h-10 sm:w-16 sm:h-16 border-t-2 sm:border-t-4 border-r-2 sm:border-r-4 border-[#2d1654] transition-all duration-500"
                style={{ transform: isHovered ? 'translate(4px, -4px)' : 'translate(0, 0)' }}
              ></div>
              <div 
                className="absolute bottom-0 left-0 w-10 h-10 sm:w-16 sm:h-16 border-b-2 sm:border-b-4 border-l-2 sm:border-l-4 border-[#2d1654] transition-all duration-500"
                style={{ transform: isHovered ? 'translate(-4px, 4px)' : 'translate(0, 0)' }}
              ></div>
              <div 
              ...
              {/* Floating badges */}
              <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 p-2 sm:p-3 bg-[#2d1654] shadow-2xl shadow-[#2d1654]/50 animate-float">
