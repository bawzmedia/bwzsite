  ...
  return (
    <>
      <section id="services" className="relative py-16 sm:py-20 md:py-24 bg-gradient-to-b from-black via-[#0a0510] to-black overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#2d1654] rounded-full blur-[200px] opacity-20"></div>
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                >
                  <service.icon 
                    ...
                    style={{ color: service.color === '#2d1654' ? '#E9A820' : service.color }}
                  />
                </div>
          ...
          <div className="relative">
            {/* Glow effect */}
            <div className="absolute -inset-2 bg-gradient-to-r from-[#2d1654] via-[#3d1f5c] to-[#2d1654] blur-xl opacity-40"></div>
            
            <div className="relative bg-gradient-to-br from-[#2d1654] via-[#2d1654]/80 to-[#0a0510] border-2 border-[#2d1654] p-6 sm:p-8 md:p-10">
              {/* Corner accents */}
